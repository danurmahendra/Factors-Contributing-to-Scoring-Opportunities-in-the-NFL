...
2. *How can the owner/curator/manager of the dataset be contacted (for example, email address)?*
	- The owner, Daren Willman, can be contacted by Twitter @darenw or email darenw@gmail.com
...
Willman, Darren. (2010) NFL Savant: 2020 play by play data. Retrieved from http://nflsavant.com/about.php

Otten, M. P., & Miller, T. J. (2015). A Balanced Team Wins Championships: 66 Years of Data from the National Basketball Association and the National Football League. Perceptual and Motor Skills, 121(3), 654–665. https://doi.org/10.2466/30.26.PMS.121c25x4
